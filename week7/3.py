...
class BankAccount:
    ...
    def _balance(self, value):
        if not isinstance(value, (int, float)):
            raise ValueError(
                f"balance must be int and higher than {self._min_balance}")
    ...
    def withdraw(self, value):
        try:
            ...
            print(
                f"${value} was withdrawed from your account your balance is ${self._balance}")
    ...
    def deposit(self, value):
        try:
            ...
            print(
                f"${value} was deposited to your account your balance is ${self._balance}")
    ...
    def transmition(self, other: 'BankAccount', value):
        try:
            ...
            print(
                f"${value} was transmited to {other._name} your balance is ${self._balance}")
